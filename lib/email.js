...
const FROM_EMAIL = process.env.RESEND_FROM_EMAIL || 'Maluar AI <noreply@maluar-ai.vercel.app>';
        ...
        html: `
          <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 560px; margin: 0 auto; padding: 32px 24px; color: #16152B;">
            ...
            <div style="text-align: center; margin: 28px 0;">
              <a href="https://maluar-ai.vercel.app" style="background: linear-gradient(135deg, #7F77DD, #D4537E); color: white; padding: 12px 32px; border-radius: 8px; text-decoration: none; font-weight: 600; display: inline-block;">
                Acessar Maluar AI
              </a>
            </div>
